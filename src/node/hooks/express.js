...
const CoordinatedSecretRotator = require('../utils/CoordinatedSecretRotator');
...
exports.restartServer = async () => {
  ...
  if (keyRotationInterval && sessionLifetime) {
    keyRotator = new CoordinatedSecretRotator(
        'expressSessionSecrets', keyRotationInterval, sessionLifetime, settings.sessionKey);
    await keyRotator.start();
    secret = keyRotator.secrets;
  }
